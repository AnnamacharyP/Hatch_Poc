...
<img className={styles.img} src="https://www.hatch.com/-/media/Hatch-Corporate/Homepage/Campaign/CIM-2023AwardWinner.jpg" alt="" />
</div>
<div className={styles.sidebarBlock_richText }>
        <h3><img alt="trophy" className={styles.cim_trophy} src="https://www.hatch.com/-/media/Hatch-Corporate/Homepage/Campaign/CIM_Safety_Award_Trophy_clear.png" />Nominate a Canadian Mining and Minerals Project online today!</h3>
<p><em>Nominations close December 11, 2023</em></p>
<p>The Hatch-CIM Mining and Minerals Project Development Safety Award recognizes project safety programs that achieve above-average statistics, feature rigorous training, and have regular auditing.</p><br/>
<div id={styles.cta_more}><a href="/About-Us/News-And-Media/2023/11/Nominations-open-2024-Hatch-CIM-safety-award">Learn more</a></div>
</div>
    </section>
  )
}

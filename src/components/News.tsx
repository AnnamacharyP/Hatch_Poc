...
const News = () => {
  return (
    <>
      <h3 className={styles.h3news}><a href="https://www.hatch.com/About-Us/News-And-Media">Recent News</a></h3> 
      <div style={{display:'flex' , gap:'10rem'}}>
<div className={styles.news_hub}>
    <div className= {styles.news_card_contain}>
        <div className= {styles.news_text}>
       <p> Reaffirming our dedication to sustainability through ISO 14001:2015 recertification</p>
        <div className={styles.news_cta}><a href="https://www.hatch.com/About-Us/News-And-Media/2024/01/Reaffirming-our-dedication-to-sustainability-through-ISO-14001-2015-recertification">Read more</a></div>
        </div>
        <div className= {styles.news_card}>
           <img src="https://www.hatch.com/-/media/Hatch-Corporate/News/2024/ISO-14001_2015_ANAB_color.jpg" alt="" />
        </div>
    </div>
</div>
<div className={styles.news_hub}>
    <div className= {styles.news_card_contain}>
        ...
        <div className= {styles.news_card}>
           <img src="https://www.hatch.com/-/media/Hatch-Corporate/News/2024/HatchSecuresPlatinumEliteStatusinReNewCanadasTop100InfrastructureProjectsOG2.png" alt="" />
        </div>
    </div>
</div>
</div>
